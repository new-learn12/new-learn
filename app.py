...
section[data-testid="stMain"]{{padding:10px 0 0!important;overflow:hidden!important;display:flex!important;flex-direction:column!important;justify-content:flex-start!important;height:100vh!important}}
[data-testid="stMainBlockContainer"]{{padding:0rem 0.4rem 0rem!important;max-width:100%!important;overflow-x:hidden!important}}
.main .block-container{{padding:0rem 0.4rem 0rem!important;max-width:100%!important;overflow-x:hidden!important}}
[data-testid="stElementContainer"]{{margin-bottom:0!important;padding-bottom:0!important;margin-top:0!important;padding-top:0!important}}
[data-testid="stMarkdownContainer"]{{padding:0!important;margin:0!important}}
.stMarkdown>div{{padding:0!important;margin:0!important}}
...
.landing-pill{{font-size:11px;color:#34567a;background:#e9f2ff;border:1px solid #d6e7ff;border-radius:999px;padding:3px 11px;white-space:nowrap}}
.hero{{
...
.badge-pill{{display:inline-block;background:#deecff;color:#174f87;font-size:11px;font-weight:700;padding:2px 10px;border-radius:999px}}
.hero h1{{margin:3px 0 2px;font-size:24px;line-height:1.2;letter-spacing:-.6px;color:var(--nl-text)}}
.hero p{{margin:0 auto;color:var(--nl-muted);font-size:12.5px;line-height:1.4;max-width:760px}}
.hero-btn-note{{margin-top:2px;color:#6d7f93;font-size:12px}}
.btn-row{{display:flex;justify-content:center;gap:12px;flex-wrap:wrap;margin-top:4px}}

.stButton>button{{padding:8px 12px!important;min-height:46px!important;font-size:13px!important}}

.section-cards{{padding:10px 2px 6px}}
.section-cards h2{{font-size:21px;text-align:center;margin:0 0 4px;letter-spacing:-.35px;color:var(--nl-text)}}
.section-cards .sub{{text-align:center;color:#6d7f93;font-size:13px;margin-bottom:4px}}
.edu-card{{
...
.icon-wrap{{width:28px;height:28px;border-radius:7px;display:flex;align-items:center;justify-content:center;font-size:15px;margin-bottom:4px;background:#e7f1ff}}
.edu-card h5{{margin:0 0 3px;font-size:13px;color:#17385e}}
.edu-card p{{margin:0;color:#5c7288;font-size:11.5px;line-height:1.5}}
.landing-footer{{
    margin-top:6px;
...
""",
    ...
    st.markdown(
        '<p class="hero-btn-note" style="text-align:center;margin:2px 0 4px;">원하는 전공 카드를 선택하면 해당 챗봇으로 즉시 이동합니다.</p>',
        unsafe_allow_html=True,
    )
...
def render_chat():
    with st.sidebar:
        st.markdown(
            """
<div style="padding:10px 16px 10px;border-bottom:1px solid #e9ecef;margin-bottom:4px;">
  <div style="font-size:18px;font-weight:700;color:#185FA5;letter-spacing:-0.3px;">NewLearn</div>
  <div style="font-size:11.5px;color:#868e96;margin-top:3px;">과목을 선택해 학습을 시작하세요</div>
</div>
""",
            unsafe_allow_html=True,
        )
